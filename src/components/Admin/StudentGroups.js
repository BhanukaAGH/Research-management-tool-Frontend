...
const StudentGroups = () => {
    ...
    return data.map((user) => {
      ...
      return (
        <tr class='border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-[#3a454b]'>
          ...
          <td class='whitespace-nowrapont-medium text-gray-900 dark:text-white'>
            {user.groupID}
          </td>
          ...
          <td class='px-6 py-4 text-right'>
            <a
              ...
              onClick={() => {setGroupID(user._id);setAllocate(true)}}
            >
              Allocate
            </a>
  ...
  return (
  <div className='p-5 overflow-auto w-full h-full'>StudentGroups
