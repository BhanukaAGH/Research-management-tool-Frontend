              ...
              <div className='relative rounded-lg bg-white shadow'>
                ...
                <div className='px-6 py-6 lg:px-8'>
                  ...
                  <form className='space-y-6'  onSubmit={onSubmit}>
                    ...
                    <label for="message" className='mb-2 block text-sm font-medium text-gray-900'>Description</label>
                    <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-white-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-white-700 dark:border-white-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Description..."
